...
#[cfg(any(not(all(target_arch = "wasm32", not(target_os = "emscripten"))), target_os = "emscripten"))]
...
#[cfg(all(feature = "inspection", any(not(all(target_arch = "wasm32", not(target_os = "emscripten"))), target_os = "emscripten")))]
...
#[cfg(all(
    ...
    any(not(all(target_arch = "wasm32", not(target_os = "emscripten"))), target_os = "emscripten"),
...
pub enum Error {
    ...
    #[cfg(all(feature = "glow", any(not(all(target_arch = "wasm32", not(target_os = "emscripten"))), target_os = "emscripten")))]

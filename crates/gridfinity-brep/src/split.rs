...
use crate::geom::{Curve, Surface, radial_frame};
use crate::isect::{Intersection, intersect_surfaces};
use crate::math::{Dir, Vec2, Vec3};
use crate::sketch::{point_in_polygon, polygon_area};
use crate::topo::{Builder, EdgeId, Solid, VertexId};
...
mod tests {
    ...
    fn volume(solid: &crate::topo::Solid) -> f64 {
        volume_at(solid, 12)
    }

    fn volume_at(solid: &crate::topo::Solid, segs: usize) -> f64 {
    ...
    fn assert_mesh_closed(solid: &crate::topo::Solid) {

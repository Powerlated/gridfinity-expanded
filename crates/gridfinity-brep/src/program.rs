...
use crate::chamfer::chamfer_edges;
use crate::fillet;
use crate::geom::Surface;
use crate::math::{Vec3, vec3_of};
use crate::sketch::{Seg, Sketch};
use crate::slab::{self, Slab, SlabOpts};
...
pub fn run_reporting(
    ...
    let _perf = crate::perf::scope(crate::perf::Metric::ProgramRun);
...
mod tests {
    ...
    fn box_with_hole_program(profile: HoleProfile) -> Program {
        ...
        p.push(
            "hole",
            Op::Hole {
                at: crate::math::Vec2::new(10.0, 10.0),
                from_z: 0.0,
                profile,
            },
        );

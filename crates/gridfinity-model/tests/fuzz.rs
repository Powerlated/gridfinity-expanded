...
use gridfinity_model::{Solid, audit, tessellation_leaks};
use rayon::prelude::*;
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_inner_walls -- --ignored --exact --nocapture"]
fn fuzz_inner_walls() {
    run(
        Options {
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_tidy_inner_walls -- --ignored --exact --nocapture"]
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_wall_openings -- --ignored --exact --nocapture"]
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_openings_and_inner_walls -- --ignored --exact --nocapture"]
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_stripped_polyominoes -- --ignored --exact --nocapture"]
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_bin_shapes -- --ignored --exact --nocapture"]
fn fuzz_bin_shapes() {
    run(
        Options {
            shape: Shape::Polyomino,
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_split_pieces -- --ignored --exact --nocapture"]
...
#[test]
#[ignore = "fuzzing is opt-in: cargo test --release -p gridfinity-model --test fuzz fuzz_params_broad -- --ignored --exact --nocapture"]

...
pub(super) const MAGNET_RADIUS: f32 = 3.25;

pub(super) const MAGNET_DEPTH: f32 = 2.4;

pub(super) const SCREW_RADIUS: f32 = 1.5;

pub(super) const SCREW_DEPTH: f32 = 6.0;

pub(super) const FASTENER_INSET: f32 = 13.0;

pub(super) const PEG_W_BOTTOM: f32 = 35.6;

pub(super) const PEG_W_MID: f32 = 37.2;

pub(super) const PEG_W_TOP: f32 = 41.5;

pub(super) const PEG_R_BOTTOM: f32 = 0.8;

pub(super) const PEG_R_MID: f32 = 1.6;

pub(super) const PEG_TANGENT: f32 = HALF_TOL + OUTER_R;

pub(super) const REENTRANT_FILLET_OVERHANG: f32 = 8.0;
...
pub(super) const SLOPED_MIN_WALL: f32 = OUTER_R * (1.0 - std::f32::consts::FRAC_1_SQRT_2) + 0.05;
...
pub(super) const MIN_USEFUL_BLEND: f32 = 0.01;
...
pub(super) const MIN_QUAD_ROUND: f32 = 0.02;
...
pub(super) const MIN_STRAIGHT_RUN: f32 = 1e-4;
...
/// at least `MIN_WALL / 2`.
pub(super) const INSET_SAME: f32 = 1e-6;
...
pub(super) const TURN_SIGN: f32 = 0.5;
...
pub(super) const SLOPE_RIM_HEADROOM: f32 = 0.5;
...
pub(super) const SLOPE_ISLAND_HEADROOM: f32 = 0.2;
...
/// built flat.
pub(super) const MIN_SLOPE_SPAN: f32 = 1e-6;
...
pub(super) const MIN_WALL: f32 = 0.4;
...
/// the arc at a point.
pub(super) const OPEN_WALL_HEADROOM: f32 = 0.6;
...
pub(super) const FILLET_DEPTH_HEADROOM: f32 = 0.05;
...
pub(super) const FILLET_CORNER_HEADROOM: f32 = 0.02;
...
pub(super) const MIN_ROUNDED_CORNER: f32 = 0.05;
...
pub(super) fn buildable_wall_thickness(want: f32, openish: bool, sloped: bool) -> f32 {
...
pub(super) fn buildable_floor_fillet(want: f32, cavity_depth: f32, rc: f32, sloped: bool) -> f32 {
...
pub(super) const ARC_ENDPOINT_ANGLE: f32 = 1e-4;
